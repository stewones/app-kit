...
'use strict';
angular.module('core.list').controller('ListFilterBoxCtrl', /*@ngInject*/ function($scope, $stateParams, $state, $location) {
    var vm = this;
})
'use strict';
